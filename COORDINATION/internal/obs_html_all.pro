...
printf, 2, 'OBS ID:<a href='+htmlname+'> '+obsid+'</a>'
printf, 2, '  DETECTOR: <font COLOR=#00FFFF>' + instrument +'</font>'
printf, 2,'  GRATING:  <font COLOR=#00FFFF>' +grating+ '</FONT>'
printf, 2, '  Target Name: <font COLOR=#00FFFF>' +targetname + '</font> <br> '


;printf, 2, '<h2>OBS ID:<a href='+htmlname+'> '+obsid+'</a></TH></h3>'
